...
boolean isCountingSecondary = false;
...
/*
 When speed first goes over 35, record startTime (need a Boolean flag so startTime isn't overwritten)
 When currTime > startTime + 15sec, AnemData = 0.
